...
/**
 * DepositantsResponse Class Doc Comment
 *
 * @category Class
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DepositantsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DepositantsResponse';
     ...
     * Sets clabe
     *
     * @param string $clabe Cuenta CLABE (es de 18 dígitos) del depositante.
     *
     * @return $this
     */
