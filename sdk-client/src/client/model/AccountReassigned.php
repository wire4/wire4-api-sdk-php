...
/**
 * AccountReassigned Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AccountReassigned implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountReassigned';
...
'status' => 'getStatus'    ];
     ...
     * Sets currency_code
     *
     * @param string $currency_code Código de moneda, este dato es opcional, al registrar una cuenta si no se cuenta con este valor se asignara MXP
     *
     * @return $this
     */
