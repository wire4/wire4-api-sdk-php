...
'sender_bank_key' => 'getSenderBankKey'    ];
     ...
     *
     * @param string $beneficiary_account Cuenta de beneficiario
     *
     * @return $this
     */
     ...
     *
     * @param string $beneficiary_bank_key Clave del banco beneficiario, se puede obtener este valor del listado de institucines '/institutions'. Si este valor no esta presente se obtiene de la cuenta del beneficiario, si la cuenta de beneficiario es un número celular este campo es requerido
     *
     * @return $this
     */
     ...
     * Sets operation_date
     *
     * @param string $operation_date Fecha de operación de la transferencia, formato: dd-MM-yyyy
     *
     * @return $this
     */
     ...
     * Sets reference
     *
     * @param string $reference Referencia numérica de la transferencia
     *
     * @return $this
     */
     ...
     * Sets sender_account
     *
     * @param string $sender_account Cuenta ordenante, es requerida cuando se no se envía la clave del banco ordenante
     *
     * @return $this
     */
     ...
     *
     * @param string $sender_bank_key Clave del banco ordenante, se puede obtener este valor del listado de institucines '/institutions'. Es requerida cuando no se envía la cuenta ordenante
     *
     * @return $this
     */
