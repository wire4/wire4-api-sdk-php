...
/**
 * MessageSalesPoint Class Doc Comment
 *
 * @category Class
 * @description Es el objet del mensaje que se envía con la información del punto de venta registrado.
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MessageSalesPoint implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MessageSalesPoint';
...
'name' => 'getName'    ];
     ...
     * Sets account
     *
     * @param string $account Es la cuenta donde se realziarán los pagos.
     *
     * @return $this
     */
     ...
     * Sets ip
     *
     * @param string $ip Dirección IP desde la cuál se accederá a la API.
     *
     * @return $this
     */
