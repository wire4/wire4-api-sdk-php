...
'name' => 'getName'    ];
     ...
     * Sets alias
     *
     * @param string $alias Es el alias del depositante. Se valida hasta 80 caracteres.
     *
     * @return $this
     */
     ...
     * Sets currency_code
     *
     * @param string $currency_code Es el código de divisa en que operará el depositante. Es en el formato estándar de 3 dígitos.  Sólo se permiten los valores <b>MXP</b> y <b>USD</b>.
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string[] $email Es la lista de correos electrónicos (emails) del depositante. <br><br><b>Ejemplo</b>: mi_correo@correo.com,mi_correo@correo.com...
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Es el nombre del depositante. Se valida hasta 120 caracteres.
     *
     * @return $this
     */
