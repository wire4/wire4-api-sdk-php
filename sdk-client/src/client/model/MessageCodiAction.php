 ...
 *
 * @category Class
 * @description El mensaje que se envía con la informacion del punto de venta registrado
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
...
'transaction_id' => 'getTransactionId'    ];
     ...
     * Sets amount
     *
     * @param float $amount Monto de la operación de pago
     *
     * @return $this
     */
     ...
     * Sets due_date
     *
     * @param \DateTime $due_date Fecha de expiración de la operación
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param string $id Uuid de la operación
     *
     * @return $this
     */
     ...
     * Sets metadata
     *
     * @param string $metadata Metadata asociada a la petición de pago
     *
     * @return $this
     */
     ...
     * Sets operation_date
     *
     * @param \DateTime $operation_date Fecha de la operación
     *
     * @return $this
     */
     ...
     * Sets order_id
     *
     * @param string $order_id Identificador de la petición
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Estado de la operación de pago
     *
     * @return $this
     */
     ...
     * Sets transaction_id
     *
     * @param string $transaction_id Id de la transacción
     *
     * @return $this
     */
