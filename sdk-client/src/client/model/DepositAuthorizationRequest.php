...
/**
 * DepositAuthorizationRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DepositAuthorizationRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DepositAuthorizationRequest';
    ...
    protected static $swaggerTypes = [
        'enabled' => 'bool',
'webhook' => '\mx\wire4\client\model\WebHookDepositAuthorizationRequest',
'wh_uuid' => 'string'    ];
...
'wh_uuid' => 'getWhUuid'    ];
     ...
     * Sets enabled
     *
     * @param bool $enabled Indica sí se aplica la autorización de depósitos.
     *
     * @return $this
     */
     ...
     * Gets webhook
     *
     * @return \mx\wire4\client\model\WebHookDepositAuthorizationRequest
     */
     ...
     * Sets webhook
     *
     * @param \mx\wire4\client\model\WebHookDepositAuthorizationRequest $webhook webhook
     *
     * @return $this
     */
