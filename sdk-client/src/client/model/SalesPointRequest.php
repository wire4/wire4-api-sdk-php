...
'notifications_url' => 'getNotificationsUrl'    ];
     ...
     * Sets access_ip
     *
     * @param string $access_ip Es la dirección IP desde donde se recibirán las peticiones de este punto de venta
     *
     * @return $this
     */
     ...
     * Sets account
     *
     * @param string $account Es el número de cuenta CLABE donde se realizará el deposito del cobro CODI®.
     *
     * @return $this
     */
     ...
     *
     * @param string $notifications_url Es la dirección URL para envíar notificaciones CODI® al punto de venta.
     *
     * @return $this
     */
