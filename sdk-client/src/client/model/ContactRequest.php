...
'phone_number' => 'getPhoneNumber'    ];
     ...
     * Sets address
     *
     * @param string $address Es la dirección del contacto, por ejemplo: Calle fulanita No. 500 int 2, Col. Conocida.
     *
     * @return $this
     */
     ...
     * Sets company
     *
     * @param string $company Es el nombre de la empresa.
     *
     * @return $this
     */
     ...
     * Sets contact_person
     *
     * @param string $contact_person Es el nombre completo de la persona quién será contactada.
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string $email Es el correo electrónico (email) de la persona. Se valida que tenga el formato de email, por ejemplo: correo@correo.com.
     *
     * @return $this
     */
     ...
     * Sets phone_number
     *
     * @param string $phone_number Es el número de teléfono de la persona. Se validan que sean 10 dígitos del número.
     *
     * @return $this
     */
