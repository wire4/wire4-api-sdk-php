 ...
 *
 * @category Class
 * @description El mensaje que se envía mediante (webHook) con la información de una transferencia que esta pendiente de ser completada
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
...
'transaction_id' => 'getTransactionId'    ];
     ...
     * Sets account
     *
     * @param string $account Cuenta del ordenante
     *
     * @return $this
     */
     ...
     *
     * @param string $beneficiary_account Cuenta del beneficiario
     *
     * @return $this
     */
     ...
     * Sets concept
     *
     * @param string $concept Concepto de la transferencia de salida
     *
     * @return $this
     */
     ...
     * Sets currency_code
     *
     * @param string $currency_code Código de la moneda de la transferencia de salida
     *
     * @return $this
     */
     ...
     *
     * @param string $detention_message Mensaje de detención de Monex, indica la causa por la cuál esta detenida la operación en Monex
     *
     * @return $this
     */
     ...
     *
     * @param int $payment_order_id El identificador de la orden de pago de Monex de la transferencia de salida
     *
     * @return $this
     */
     ...
     * Sets reference
     *
     * @param int $reference Referecia de la transferencia
     *
     * @return $this
     */
     ...
     * Sets status_code
     *
     * @param string $status_code El estado de la transferencia de salida, deberá ser PENDING
     *
     * @return $this
     */
     ...
     * Sets transaction_id
     *
     * @param int $transaction_id El identificador de Monex de la transferencia de salida, podría no estar presente por lo que Usted debería hacer referencias mediate el paymentOrderID
     *
     * @return $this
     */
