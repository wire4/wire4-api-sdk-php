...
'sender_rfc' => 'getSenderRfc'    ];
     ...
     * Sets confirm_date
     *
     * @param \DateTime $confirm_date Es la fecha de confirmación del deposito. Ésta fecha viene en formato ISO 8601 con zona horaria, ejemplo: <strong>2020-10-27T11:03:15.000-06:00</strong>.
     *
     * @return $this
     */
     ...
     * Sets currency_code
     *
     * @param string $currency_code Es el código de divisa de la transferencia. Es en el formato estándar de 3 dígitos, por ejemplo para el peso mexicano: <b>MXP</b>, para el dólar estadounidense: <b>USD</b>.
     *
     * @return $this
     */
     ...
     * Sets deposit_date
     *
     * @param \DateTime $deposit_date Es la fecha del deposito.  Ésta fecha viene en formato ISO 8601 con zona horaria, ejemplo: <strong>2020-10-27T11:03:15.000-06:00</strong>.
     *
     * @return $this
     */
     ...
     * Sets depositant
     *
     * @param string $depositant Es el depositante.
     *
     * @return $this
     */
     ...
     *
     * @param string $depositant_clabe Es la Cuenta CLABE interbancaria (de 18 dígitos) del depositante.
     *
     * @return $this
     */
     ...
     *
     * @param string $depositant_email Es el correo electrónico (email) del depositante.
     *
     * @return $this
     */
     ...
     * Sets depositant_rfc
     *
     * @param string $depositant_rfc Es el Registro Federal de Contribuyentes (RFC) del depositante.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description Es la descripción del traspaso.
     *
     * @return $this
     */
     ...
     *
     * @param string $monex_description Es la descripción directa de Monex.
     *
     * @return $this
     */
     ...
     *
     * @param string $monex_transaction_id es el identificador de la transferencia en Monex.
     *
     * @return $this
     */
     ...
     * Sets reference
     *
     * @param string $reference Es la referencia del depósito.
     *
     * @return $this
     */
     ...
     * Sets sender_account
     *
     * @param string $sender_account Es la cuenta del ordenante.
     *
     * @return $this
     */
     ...
     * Sets sender_rfc
     *
     * @param string $sender_rfc Es el Registro Federal de Contribuyentes (RFC) de la cuenta ordenante.
     *
     * @return $this
     */
