...
/**
 * SpidClassificationsResponseDTO Class Doc Comment
 *
 * @category Class
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SpidClassificationsResponseDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SpidClassificationsResponseDTO';
    ...
    protected static $swaggerTypes = [
        'classifications' => '\mx\wire4\client\model\SpidClassificationDTO[]'    ];
     ...
     *
     * @return \mx\wire4\client\model\SpidClassificationDTO[]
     */
     ...
     *
     * @param \mx\wire4\client\model\SpidClassificationDTO[] $classifications Lista de clasificaciones para operaciones con dólares (SPID)
     *
     * @return $this
     */
