...
/**
 * MessageConfigurationsLimits Class Doc Comment
 *
 * @category Class
 * @description Configuración de límites de montos.
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MessageConfigurationsLimits implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MessageConfigurationsLimits';
    ...
    protected static $swaggerTypes = [
        'configurations' => '\mx\wire4\client\model\ConfigurationsLimits[]'    ];
     ...
     * Gets configurations
     *
     * @return \mx\wire4\client\model\ConfigurationsLimits[]
     */
     ...
     * Sets configurations
     *
     * @param \mx\wire4\client\model\ConfigurationsLimits[] $configurations Lista de configuraciones pertenecientes al contrato
     *
     * @return $this
     */
