...
'status' => 'getStatus'    ];
     ...
     * Sets business_name
     *
     * @param string $business_name Nombre de la empresa registrada
     *
     * @return $this
     */
     ...
     * Sets certificate
     *
     * @param string $certificate La información del certificado
     *
     * @return $this
     */
     ...
     * Sets comercial_name
     *
     * @param string $comercial_name Nombre comercial de la empresa registrada
     *
     * @return $this
     */
     ...
     * Sets rfc
     *
     * @param string $rfc RFC de la empresa registrada
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status El estado de la compañía
     *
     * @return $this
     */
