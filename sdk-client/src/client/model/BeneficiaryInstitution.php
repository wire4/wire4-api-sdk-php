...
/**
 * BeneficiaryInstitution Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BeneficiaryInstitution implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BeneficiaryInstitution';
     ...
     * Sets name
     *
     * @param string $name Nombre de la institución / empresa (persona moral) propietaria la cuenta bancaria
     *
     * @return $this
     */
