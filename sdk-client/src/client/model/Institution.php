...
'rfc' => 'getRfc'    ];
     ...
     * Sets company_name
     *
     * @param string $company_name Es la razón social de la institución.
     *
     * @return $this
     */
     ...
     * Sets key
     *
     * @param string $key Es la clave de BANXICO que pertenece a la institución.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Es el nombre de la institución.
     *
     * @return $this
     */
     ...
     * Sets rfc
     *
     * @param string $rfc Es el Registro Federal de Contribuyente (RFC) que pertenece a la institución bancaria.
     *
     * @return $this
     */
