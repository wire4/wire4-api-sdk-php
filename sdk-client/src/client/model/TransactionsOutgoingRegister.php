 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransactionsOutgoingRegister implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransactionsOutgoingRegister';
...
'return_url' => 'string',
'transactions' => '\mx\wire4\client\model\TransactionOutgoing[]'    ];
...
'transactions' => 'getTransactions'    ];
     ...
     * Gets transactions
     *
     * @return \mx\wire4\client\model\TransactionOutgoing[]
     */
     ...
     * Sets transactions
     *
     * @param \mx\wire4\client\model\TransactionOutgoing[] $transactions Lista de transferencias de salida que se enviarán a Monex.
     *
     * @return $this
     */
