...
/**
 * PreEnrollmentResponse Class Doc Comment
 *
 * @category Class
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PreEnrollmentResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Pre-EnrollmentResponse';
...
'url' => 'getUrl'    ];
     ...
     *
     * @param string $subscription_id Es el identificador público generado para la suscripción.
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string $url Es la dirección URL del centro de autorizción para confirmación del alta de la suscripción.
     *
     * @return $this
     */
