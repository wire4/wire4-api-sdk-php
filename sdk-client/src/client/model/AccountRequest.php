...
class AccountRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'accounts' => '\mx\wire4\client\model\Account[]',
...
'return_url' => 'getReturnUrl'    ];
     ...
     * Sets accounts
     *
     * @param \mx\wire4\client\model\Account[] $accounts Lista de cuentas de beneficiario que serán registradas.
     *
     * @return $this
     */
     ...
     *
     * @param string $cancel_return_url Es la dirección URL a la que se redirigirá en caso de que el cliente cancele el registro.
     *
     * @return $this
     */
     ...
     * Sets return_url
     *
     * @param string $return_url Es la dirección URL a la que se redirigirá en caso exitoso.
     *
     * @return $this
     */
