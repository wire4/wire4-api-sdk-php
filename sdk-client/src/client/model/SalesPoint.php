 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SalesPoint implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SalesPoint';
...
'sales_point_id' => 'getSalesPointId'    ];
     ...
     * Sets account
     *
     * @param string $account Cuenta CLABE
     *
     * @return $this
     */
