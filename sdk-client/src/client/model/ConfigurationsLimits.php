...
/**
 * ConfigurationsLimits Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConfigurationsLimits implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConfigurationsLimits';
    ...
    protected static $swaggerTypes = [
        'group' => 'string',
'items' => '\mx\wire4\client\model\Item[]'    ];
...
'items' => 'getItems'    ];
     ...
     * Sets group
     *
     * @param string $group Nombre del grupo de configuraciones. Debe ser LIMIT_BY_TIME para especificar la configuración por límite por horario, LIMIT_BY_RANGE para especificar límite por periodo o LIMIT_BY_SCHEDULE para especificar el horario de operaciones
     *
     * @return $this
     */
     ...
     * Gets items
     *
     * @return \mx\wire4\client\model\Item[]
     */
     ...
     * Sets items
     *
     * @param \mx\wire4\client\model\Item[] $items Lista de items configurados
     *
     * @return $this
     */
