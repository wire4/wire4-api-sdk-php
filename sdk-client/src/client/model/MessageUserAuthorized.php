...
'user_name' => 'getUserName'    ];
     ...
     * Sets account
     *
     * @param string $account Es el contrato al que se le brinda el acceso a la API.
     *
     * @return $this
     */
     ...
     * Sets masked_account
     *
     * @param string $masked_account Es el contrato enmascarado al cual se le brinda el acceso a la API.
     *
     * @return $this
     */
     ...
     * Sets masked_name
     *
     * @param string $masked_name Es el usuario enmascarado que se autorizó.
     *
     * @return $this
     */
     ...
     *
     * @param string $masked_user_name Es el nombre enmascarado del usuario de acceso que se autorizó.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Es el usuario que se autorizó.
     *
     * @return $this
     */
     ...
     * Sets request_id
     *
     * @param string $request_id Es el identificador de la petición cuando se solicitó la autorización.
     *
     * @return $this
     */
     ...
     * Sets user_name
     *
     * @param string $user_name Es el nombre del usuario de acceso que se autorizó.
     *
     * @return $this
     */
