 ...
 *
 * @category Class
 * @description Es el objeto del mensaje que se envía mediante webhook con la información de la transferencia de salida realizada.
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MessagePayment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MessagePayment';
...
'transaction_id' => 'getTransactionId'    ];
     ...
     * Sets confirm_date
     *
     * @param \DateTime $confirm_date Es la fecha de confirmación de la transferencia de salida.
     *
     * @return $this
     */
     ...
     *
     * @param string $detention_message Es el mensaje de detención de Monex de la transferencia de salida.
     *
     * @return $this
     */
     ...
     *
     * @param string $monex_description La descripción de Monex de la transferencia de salida.
     *
     * @return $this
     */
     ...
     * Sets order_id
     *
     * @param string $order_id Es el identificador de la transferencia de salida.
     *
     * @return $this
     */
     ...
     * Sets pending_reason
     *
     * @param string $pending_reason Es la razón de porque está pendiente aún cuando se autorizó la transferencia.
     *
     * @return $this
     */
     ...
     * Sets request_id
     *
     * @param string $request_id El identificador en esta API de la petición de envío de la transferencia de salida.
     *
     * @return $this
     */
     ...
     * Sets status_code
     *
     * @param string $status_code Es el estado de la transferencia de salida.
     *
     * @return $this
     */
     ...
     * Sets transaction_id
     *
     * @param int $transaction_id Es el identificador de Monex de la transferencia de salida.
     *
     * @return $this
     */
