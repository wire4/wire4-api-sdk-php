...
'transaction_id' => 'getTransactionId'    ];
     ...
     * Sets account
     *
     * @param string $account Cuenta emisora
     *
     * @return $this
     */
     ...
     * Sets confirm_date
     *
     * @param \DateTime $confirm_date Fecha de aplicación de la transferencia
     *
     * @return $this
     */
     ...
     *
     * @param string $detention_message Mensaje proporcionado por Monex para la transferencia
     *
     * @return $this
     */
     ...
     * Sets error_message
     *
     * @param string $error_message Mensaje de error, en caso de algún error se informará aquí
     *
     * @return $this
     */
     ...
     *
     * @param string $monex_description Descripción
     *
     * @return $this
     */
     ...
     * Sets order_id
     *
     * @param string $order_id Identificador asignado por la aplciación a la transferencia
     *
     * @return $this
     */
     ...
     *
     * @param int $payment_order_id Identificador de la orden de pago en Monex
     *
     * @return $this
     */
     ...
     * Sets pending_reason
     *
     * @param string $pending_reason Razón de porque esta pendiente aun cuando se autorizó la transferencia
     *
     * @return $this
     */
     ...
     * Sets reference
     *
     * @param int $reference Referencia numérica
     *
     * @return $this
     */
     ...
     * Sets status_code
     *
     * @param string $status_code Estado de la transferencia de la transferencia, los posibles valores son: PENDING, COMPLETED, FAILED, CANCELLED
     *
     * @return $this
     */
     ...
     * Sets transaction_id
     *
     * @param int $transaction_id Identificador de la transferencia asignado por Monex
     *
     * @return $this
     */
