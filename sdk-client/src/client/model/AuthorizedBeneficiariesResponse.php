...
/**
 * AuthorizedBeneficiariesResponse Class Doc Comment
 *
 * @category Class
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AuthorizedBeneficiariesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuthorizedBeneficiariesResponse';
    ...
    protected static $swaggerTypes = [
        'accounts' => '\mx\wire4\client\model\AccountReassigned[]',
'request_id' => 'string',
'url' => 'string'    ];
...
'url' => 'getUrl'    ];
     ...
     * Gets accounts
     *
     * @return \mx\wire4\client\model\AccountReassigned[]
     */
     ...
     * Sets accounts
     *
     * @param \mx\wire4\client\model\AccountReassigned[] $accounts Lista de cuentas obtenidas en estado pendiente de ser autorizadas.
     *
     * @return $this
     */
     ...
     * Sets request_id
     *
     * @param string $request_id Es el identificador público generado para la petición (solicitud).
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string $url Es la dirección URL generada para confirmación de la operación. Es para ingresar al centro de autorización.
     *
     * @return $this
     */
