...
'url' => 'getUrl'    ];
     ...
     * Sets accounts
     *
     * @param \mx\wire4\client\model\AccountReassigned[] $accounts Lista de cuentas obtenidas
     *
     * @return $this
     */
     ...
     * Sets request_id
     *
     * @param string $request_id Identificador público generado para la petición
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string $url La url generada para confirmación de la operación
     *
     * @return $this
     */
