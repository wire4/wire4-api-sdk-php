...
'url' => 'getUrl'    ];
     ...
     * Sets events
     *
     * @param string[] $events Tipos de eventos de los cuales Wire4 te enviará información, para mas referencia sobre los tipos de eventos soportados, revise la siguiente liga: https://developers.wire4.mx/#section/Eventos .
     *
     * @return $this
     */
