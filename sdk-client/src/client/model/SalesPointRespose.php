...
'webhook' => 'getWebhook'    ];
     ...
     * Sets user_key
     *
     * @param string $user_key Es la llave de usuario para el API Wire4. Sólo para el uso de CODI®.
     *
     * @return $this
     */
     ...
     * Sets user_secret
     *
     * @param string $user_secret Es la contraseña para el API Wire4. Sólo para el uso de CODI®.
     *
     * @return $this
     */
