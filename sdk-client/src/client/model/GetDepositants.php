...
/**
 * GetDepositants Class Doc Comment
 *
 * @category Class
 * @description Objeto que contiene una lista de depositantes
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetDepositants implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetDepositants';
    ...
    protected static $swaggerTypes = [
        'depositants' => '\mx\wire4\client\model\Depositant[]'    ];
    ...
    {
        $this->container['depositants'] = isset($data['depositants']) ? $data['depositants'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['depositants'] === null) {
            $invalidProperties[] = "'depositants' can't be null";
        }
     ...
     * Gets depositants
     *
     * @return \mx\wire4\client\model\Depositant[]
     */
    public function getDepositants()
    {
        return $this->container['depositants'];
    }

    /**
     * Sets depositants
     *
     * @param \mx\wire4\client\model\Depositant[] $depositants Lista de depositantes que contiene cada depositante encontrado
     *
     * @return $this
     */
    public function setDepositants($depositants)
    {
        $this->container['depositants'] = $depositants;
