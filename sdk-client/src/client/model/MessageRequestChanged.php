...
'status' => 'getStatus'    ];
     ...
     * Sets request_id
     *
     * @param string $request_id Es el identificador de la petición realizada a esta API.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Es el cambio a informar en el procesamiento/estado de la petición.
     *
     * @return $this
     */
