...
'previous_amount_limit' => 'getPreviousAmountLimit'    ];
     ...
     * Sets amount_limit
     *
     * @param float $amount_limit Nuevo monto límite que reemplazará al actual, un monto de 0.0 implica que no hay límite
     *
     * @return $this
     */
     ...
     * Sets currency_code
     *
     * @param string $currency_code Código de moneda de la cuenta
     *
     * @return $this
     */
     ...
     *
     * @param float $previous_amount_limit Monto límite registrado actualmente, un monto de 0.0 implica que no hay límite
     *
     * @return $this
     */
