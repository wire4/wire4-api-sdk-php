 ...
 *
 * @category Class
 * @description Es el objeto del Comprobante Electrónico de Pago (CEP) de la transferencia, que es emitido por Banxico. Se muestra sólo cuando esté disponible, en otro caso se podrá usar la &lt;a href&#x3D;\&quot;#operation/obtainTransactionCepUsingPOST\&quot;&gt;Consulta de CEP&lt;/a&gt; que ésta misma API ofrece.
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
...
'url_zip' => 'getUrlZip'    ];
     ...
     * Sets account_sender
     *
     * @param string $account_sender Es la cuenta que envía la operación.
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param float $amount Es el monto de la operación.
     *
     * @return $this
     */
     ...
     *
     * @param string $bank_beneficiary Es la clave del banco beneficiario.
     *
     * @return $this
     */
     ...
     * Sets bank_sender
     *
     * @param string $bank_sender Es la clave del banco que envía la operación.
     *
     * @return $this
     */
     ...
     *
     * @param string $cadena_original Es la cadena original emitida por el Servicio de Administración Tributaria (SAT).
     *
     * @return $this
     */
     ...
     * Sets capture_date
     *
     * @param \DateTime $capture_date Es la fecha de captura.
     *
     * @return $this
     */
     ...
     *
     * @param string $certificate_serial_number Es el número de serie emitido por el SAT
     *
     * @return $this
     */
     ...
     * Sets clave_rastreo
     *
     * @param string $clave_rastreo Es la clave de rastreo de la operación.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description Es la descripción de la operación.
     *
     * @return $this
     */
     ...
     * Sets iva
     *
     * @param float $iva Es el Impuesto al Valor Agregado (IVA) de la operación.
     *
     * @return $this
     */
     ...
     * Sets operation_date
     *
     * @param \DateTime $operation_date Es la fecha en la que se realizó la operación.
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $operation_date_cep Es la fecha en la que se genera el CEP.
     *
     * @return $this
     */
     ...
     * Sets reference
     *
     * @param string $reference Es la Referencia de la operación
     *
     * @return $this
     */
     ...
     * Sets sender_name
     *
     * @param string $sender_name Es el nombre de quién envía la operación.
     *
     * @return $this
     */
     ...
     * Sets sender_rfc
     *
     * @param string $sender_rfc Es el Registro Federal de Contrinuyentes (RFC) de quién envía la operación.
     *
     * @return $this
     */
