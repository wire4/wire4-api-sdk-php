...
/**
 * MessageDepositReceived Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MessageDepositReceived implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MessageDepositReceived';
...
'sender_rfc' => 'getSenderRfc'    ];
     ...
     * Sets clave_rastreo
     *
     * @param string $clave_rastreo Clave de rastreo de la transferencia
     *
     * @return $this
     */
     ...
     * Sets confirm_date
     *
     * @param \DateTime $confirm_date Fecha de confirmación de la transferencia
     *
     * @return $this
     */
     ...
     * Sets currency_code
     *
     * @param string $currency_code Código de moneda de la transferencia, puede ser MXP, USD
     *
     * @return $this
     */
     ...
     * Sets deposit_date
     *
     * @param \DateTime $deposit_date Fecha de recepción de la transferencia
     *
     * @return $this
     */
     ...
     * Sets depositant
     *
     * @param string $depositant Nombre del depositante, en caso que la transferencia se reciba en una cuenta de depositante
     *
     * @return $this
     */
     ...
     *
     * @param string $depositant_clabe CLABE del depositante, en caso que la transferencia se reciba en una cuenta de depositante
     *
     * @return $this
     */
     ...
     *
     * @param string $depositant_email Correo electrónico del depositante, en caso que la transferencia se reciba en una cuenta de depositante
     *
     * @return $this
     */
     ...
     * Sets depositant_rfc
     *
     * @param string $depositant_rfc RFC del depositante, en caso que la transferencia se reciba en una cuenta de depositante
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description Concepto de la transferencia
     *
     * @return $this
     */
     ...
     *
     * @param string $monex_description Descripción de Monex para la transferencia
     *
     * @return $this
     */
     ...
     *
     * @param string $monex_transaction_id Identificador asignado por Monex a la transferencia
     *
     * @return $this
     */
     ...
     * Sets reference
     *
     * @param string $reference Referecia de la transferencia
     *
     * @return $this
     */
     ...
     * Sets sender_account
     *
     * @param string $sender_account Cuenta del ordenante, podría ser un número celular, TDD o Cuenta CLABE interbancaria
     *
     * @return $this
     */
     ...
     * Sets sender_name
     *
     * @param string $sender_name Nombre del ordenante
     *
     * @return $this
     */
     ...
     * Sets sender_rfc
     *
     * @param string $sender_rfc RFC del ordenante
     *
     * @return $this
     */
