 ...
 *
 * @category Class
 * @description Objeto que contiene el saldo, moneda y código de moneda.
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
...
'currency_code' => 'getCurrencyCode'    ];
     ...
     * Sets balance
     *
     * @param float $balance Es el monto del balance del contrato para la moneda especificada.
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param string $currency Código de divisa que opera el depositante. Es en el formato estándar de 3 dígitos, por ejemplo para el peso mexicano: <b>MXP</b>, para el dólar estadounidense: <b>USD</b>.
     *
     * @return $this
     */
     ...
     * Sets currency_code
     *
     * @param string $currency_code Código de divisa que opera el depositante. Es en el formato estándar de 3 dígitos, por ejemplo para el peso mexicano: <b>MXP</b>, para el dólar estadounidense: <b>USD</b>.
     *
     * @return $this
     */
