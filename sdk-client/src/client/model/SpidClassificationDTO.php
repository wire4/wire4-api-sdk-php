...
/**
 * SpidClassificationDTO Class Doc Comment
 *
 * @category Class
 * @description La información acerca de la clasificación de la operación.
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SpidClassificationDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SpidClassificationDTO';
...
'description' => 'getDescription'    ];
     ...
     *
     * @param string $classification_id Es el identificador de la clasificación.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description Es la descripción de la clasificación de la operación.
     *
     * @return $this
     */
