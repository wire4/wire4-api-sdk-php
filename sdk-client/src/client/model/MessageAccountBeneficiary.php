 ...
 *
 * @category Class
 * @description El mensaje que se envía mediante (webHook) con la información del registro de la cuenta del beneficiario
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
...
'request_id' => 'getRequestId'    ];
     ...
     * Sets error_message
     *
     * @param string $error_message Mensaje de error en caso de existir, el valor de este atributo contiene el mensaje
     *
     * @return $this
     */
