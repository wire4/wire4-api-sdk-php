 ...
 *
 * @category Class
 * @description Objeto que contiene la lista de movimientos del balance del contrato
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BalanceListResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BalanceListResponse';
    ...
    protected static $swaggerTypes = [
        'balances' => '\mx\wire4\client\model\Balance[]'    ];
     ...
     * Gets balances
     *
     * @return \mx\wire4\client\model\Balance[]
     */
     ...
     * Sets balances
     *
     * @param \mx\wire4\client\model\Balance[] $balances Lista de movimientos (saldos).
     *
     * @return $this
     */
