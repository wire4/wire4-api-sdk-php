...
self::STATUS_INACTIVE,        ];
     ...
     * Sets access_ip
     *
     * @param string $access_ip Ip desde la que accede el punto de venta a wire4 y a la que se devuelven las notificaciones
     *
     * @return $this
     */
     ...
     * Sets account
     *
     * @param string $account Cuenta registra para el punto de venta
     *
     * @return $this
     */
     ...
     * Sets public_id
     *
     * @param string $public_id Identificador del punto de venta
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Estatus ACTIVO/INACTIVO el punto de venta
     *
     * @return $this
     */
