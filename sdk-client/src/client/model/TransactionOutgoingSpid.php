 ...
 *
 * @category Class
 * @description Objeto que contiene la información de una transferencias SPID de salida
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
...
'return_url' => 'getReturnUrl'    ];
     ...
     *
     * @param string $cancel_return_url Url a la que se redirigirá en caso de error
     *
     * @return $this
     */
     ...
     *
     * @param string $classification_id El identificador de la clasificación de la transferencia SPID
     *
     * @return $this
     */
     ...
     *
     * @param int $numeric_reference_spid Referencia numérica de la transferencia
     *
     * @return $this
     */
     ...
     *
     * @param string $payment_concept_spid Concepto de la transferencia
     *
     * @return $this
     */
