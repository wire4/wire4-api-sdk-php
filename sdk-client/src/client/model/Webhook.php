...
self::STATUS_DELETED,        ];
     ...
     * Sets events
     *
     * @param string[] $events Tipo de evento manejado por el webhook. Para más referencia sobre los tipos de eventos soportados, revise la siguiente liga: <a href=\"#section/Eventos\">https://developers.wire4.mx/#section/Eventos.</a>
     *
     * @return $this
     */
     ...
     * Sets secret
     *
     * @param string $secret Es la llave con la que se debe de identificar que el webhook fue enviado por Wire4. Para mayor información revisar la guía de notificaciones en la sección de <a href=\"https://wire4.mx/#/guides/notificaciones\">\"Comprobación de firmas de Webhook\".</a>
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Estado (estatus) en el que se encuentra el webhook.
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string $url Es la dirección URL a la que Wire4 enviará las notificaciones cuando un evento ocurra.
     *
     * @return $this
     */
     ...
     * Sets wh_id
     *
     * @param string $wh_id Es el identificador del webhook.
     *
     * @return $this
     */
