...
self::STATUS_DELETED,        ];
     ...
     * Sets events
     *
     * @param string[] $events Tipos de eventos de los cuales Wire4 te enviará información.
     *
     * @return $this
     */
     ...
     * Sets secret
     *
     * @param string $secret Llave con la cual se debe de identificar que el webhook fue enviado por Wire4, para mayor información revisar la guía de notificaciones (https://wire4.mx/#/guides/notificaciones),  en la sección de  <a href=\"https://wire4.mx/#/guides/notificaciones\">\"Comprobación de firmas de Webhook\".</a>
     *
     * @return $this
     */
     ...
     * Sets wh_uuid
     *
     * @param string $wh_uuid Es el identificador del webhook. Ejemplo: wh_54a832866f784b439bc625c0f4e04e12.
     *
     * @return $this
     */
