...
class CodiCodeRequestDTO implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'amount' => 'float',
        'beneficiary2' => '\mx\wire4\client\model\BeneficiaryDTO',
        'concept' => 'string',
        'due_date' => '\DateTime',
        'metadata' => 'string',
        'order_id' => 'string',
    ...
    const PAYMENT_TYPE_ONE_OCCASION = 'ONE_OCCASION';
    const PAYMENT_TYPE_RECURRENT = 'RECURRENT';
    const PAYMENT_TYPE_RECURRENT_NO_RECURRENT = 'RECURRENT_NO_RECURRENT';
    ...
    {
        return [
            self::PAYMENT_TYPE_ONE_OCCASION,
            self::PAYMENT_TYPE_RECURRENT,
            self::PAYMENT_TYPE_RECURRENT_NO_RECURRENT,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['beneficiary2'] = isset($data['beneficiary2']) ? $data['beneficiary2'] : null;
     ...
     * Gets beneficiary2
     *
     * @return \mx\wire4\client\model\BeneficiaryDTO
     */
    public function getBeneficiary2()
    {
        return $this->container['beneficiary2'];
    }

    /**
     * Sets beneficiary2
     *
     * @param \mx\wire4\client\model\BeneficiaryDTO $beneficiary2 beneficiary2
     *
     * @return $this
     */
    public function setBeneficiary2($beneficiary2)
    {
        $this->container['beneficiary2'] = $beneficiary2;
     ...
     * Sets concept
     *
     * @param string $concept Descripción del pago CODI®, no debe contener letras con acentos ni caracteres especiales
     *
     * @return $this
     */
     ...
     * Sets payment_type
     *
     * @param string $payment_type El tipo de pago ya sea en una ocasión (ONE_OCCASION) o recurrente (RECURRENT)
     *
     * @return $this
     */
     ...
     * Sets reference
     *
     * @param int $reference Referencia numérica del pago CODI®. Debe ser de 7 dígitos
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type El tipo de solicitud QR o PUSH para pago con CODI®
     *
     * @return $this
     */
