...
/**
 * ContractDetailResponse Class Doc Comment
 *
 * @category Class
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContractDetailResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContractDetailResponse';
    ...
    protected static $swaggerTypes = [
        'account' => '\mx\wire4\client\model\AccountDetail',
'user' => '\mx\wire4\client\model\UserCompany'    ];
...
'user' => 'getUser'    ];
     ...
     * Gets account
     *
     * @return \mx\wire4\client\model\AccountDetail
     */
     ...
     * Sets account
     *
     * @param \mx\wire4\client\model\AccountDetail $account account
     *
     * @return $this
     */
     ...
     * Gets user
     *
     * @return \mx\wire4\client\model\UserCompany
     */
     ...
     * Sets user
     *
     * @param \mx\wire4\client\model\UserCompany $user user
     *
     * @return $this
     */
