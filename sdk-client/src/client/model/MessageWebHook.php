...
'type' => 'getType'    ];
     ...
     * Sets api_version
     *
     * @param string $api_version Es la versión de esta API.
     *
     * @return $this
     */
     ...
     * Sets data
     *
     * @param object $data Es el objeto que contiene la información del evento.
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param string $id Es el identificador del mensaje.
     *
     * @return $this
     */
     ...
     * Sets object
     *
     * @param string $object Tipo de objeto  que contiene el mensaje en el atributo 'data'. Los posibles valores son:  <ul><li>subscription</li>, <li>beneficiary</li>, <li>spei_outgoing</li>, <li>spei_incoming</li>, <li>spid_outgoing</li>, <li>request_outgoing</li><ul>
     *
     * @return $this
     */
     ...
     *
     * @param int $pending_webhooks Es el número de mensajes pendientes de enviar.
     *
     * @return $this
     */
     ...
     * Sets request
     *
     * @param string $request Es el identificador del recurso relacionado.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type El tipo evento que se está enviando en la notificación.
     *
     * @return $this
     */
