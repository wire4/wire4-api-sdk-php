...
/**
 * CertificateRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CertificateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CertificateRequest';
...
'cipher_data' => 'getCipherData'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['cipher_data'] = isset($data['cipher_data']) ? $data['cipher_data'] : null;
    }
     ...
     * Sets alias
     *
     * @param string $alias Es el alias del certificado.
     *
     * @return $this
     */
     ...
     *
     * @param string $certificate_number Es el número de certificado.
     *
     * @return $this
     */
     ...
     * Sets check_digit
     *
     * @param string $check_digit Es el dígito verificador. Es un sólo dígito.
     *
     * @return $this
     */
    ...
    {
        return $this->container['cipher_data'];
    }

    /**
     * Sets cipher_data
     *
     * @param string $cipher_data Es la información de cifrado.
     *
     * @return $this
     */
    public function setCipherData($cipher_data)
    {
        $this->container['cipher_data'] = $cipher_data;
