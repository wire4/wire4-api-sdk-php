 ...
 *
 * @category Class
 * @description Certificado de la empresa que se esta registrando
 * @package  mx\wire4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
...
'cipher_data' => 'getCipherData'    ];
     ...
     * Sets alias
     *
     * @param string $alias Alias del certificado
     *
     * @return $this
     */
     ...
     *
     * @param string $certificate_number Numero de certificado
     *
     * @return $this
     */
     ...
     * Sets check_digit
     *
     * @param string $check_digit Dígito verificador
     *
     * @return $this
     */
     ...
     * Sets cipher_data
     *
     * @param string $cipher_data Información de cifrado
     *
     * @return $this
     */
