...
class ContractsDetailsApi
{
    ...
    /**
     * Operation obtainAuthorizedUsersByContract
     *
     * Obtiene los usuarios autorizados por contrato
     *
     * @param  string $authorization Header para token (required)
     * @param  string $x_access_key La llave de acceso de la aplicación (required)
     * @param  string $contract El contrato Monex (optional)
     *
     * @throws \mx\wire4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \mx\wire4\client\model\AuthorizedUsers[]
     */
    public function obtainAuthorizedUsersByContract($authorization, $x_access_key, $contract = null)
    {
        list($response) = $this->obtainAuthorizedUsersByContractWithHttpInfo($authorization, $x_access_key, $contract);
        return $response;
    }

    /**
     * Operation obtainAuthorizedUsersByContractWithHttpInfo
     *
     * Obtiene los usuarios autorizados por contrato
     *
     * @param  string $authorization Header para token (required)
     ...
     * @return array of \mx\wire4\client\model\AuthorizedUsers[], HTTP status code, HTTP response headers (array of strings)
     */
    public function obtainAuthorizedUsersByContractWithHttpInfo($authorization, $x_access_key, $contract = null)
    {
        $returnType = '\mx\wire4\client\model\AuthorizedUsers[]';
        $request = $this->obtainAuthorizedUsersByContractRequest($authorization, $x_access_key, $contract);
    ...
    /**
     * Operation obtainAuthorizedUsersByContractAsync
     *
     * Obtiene los usuarios autorizados por contrato
     *
     * @param  string $authorization Header para token (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function obtainAuthorizedUsersByContractAsync($authorization, $x_access_key, $contract = null)
    {
        return $this->obtainAuthorizedUsersByContractAsyncWithHttpInfo($authorization, $x_access_key, $contract)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation obtainAuthorizedUsersByContractAsyncWithHttpInfo
     *
     * Obtiene los usuarios autorizados por contrato
     *
     * @param  string $authorization Header para token (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function obtainAuthorizedUsersByContractAsyncWithHttpInfo($authorization, $x_access_key, $contract = null)
    {
        $returnType = '\mx\wire4\client\model\AuthorizedUsers[]';
        $request = $this->obtainAuthorizedUsersByContractRequest($authorization, $x_access_key, $contract);
    ...
    /**
     * Create request for operation 'obtainAuthorizedUsersByContract'
     *
     * @param  string $authorization Header para token (required)
     * @param  string $x_access_key La llave de acceso de la aplicación (required)
     * @param  string $contract El contrato Monex (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function obtainAuthorizedUsersByContractRequest($authorization, $x_access_key, $contract = null)
    {
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling obtainAuthorizedUsersByContract'
            );
        }
        // verify the required parameter 'x_access_key' is set
        if ($x_access_key === null || (is_array($x_access_key) && count($x_access_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_access_key when calling obtainAuthorizedUsersByContract'
            );
        }

        $resourcePath = '/onboarding/accounts/authorized-users';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
