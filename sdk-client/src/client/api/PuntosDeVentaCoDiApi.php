...
class PuntosDeVentaCoDiApi
{
     ...
     *
     * @param  \mx\wire4\client\model\SalesPointRequest $body Es el objeto que contiene información del punto de venta CODI®. (required)
     * @param  string $authorization Header para token (required)
     * @param  string $company_id Es el identificador de la empresa. (required)
     *
     ...
     *
     * @param  string $authorization Header para token (required)
     * @param  string $company_id Es el identificador de la empresa. Ejemplo: 8838d513-5916-4662-bb30-2448f0f543ed (required)
     *
     * @throws \mx\wire4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
