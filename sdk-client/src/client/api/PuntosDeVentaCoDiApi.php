...
class PuntosDeVentaCoDiApi
{
     ...
     *
     * @param  \mx\wire4\client\model\SalesPointRequest $body salesPointRequest (required)
     ...
     */
    public function createSalesPoint($body, $authorization, $company_id, $name = null)
    {
        list($response) = $this->createSalesPointWithHttpInfo($body, $authorization, $company_id, $name);
        return $response;
    }
     ...
     */
    public function createSalesPointWithHttpInfo($body, $authorization, $company_id, $name = null)
    {
        $returnType = '\mx\wire4\client\model\SalesPointRespose';
        $request = $this->createSalesPointRequest($body, $authorization, $company_id, $name);
     ...
     */
    public function createSalesPointAsync($body, $authorization, $company_id, $name = null)
    {
        return $this->createSalesPointAsyncWithHttpInfo($body, $authorization, $company_id, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSalesPointAsyncWithHttpInfo($body, $authorization, $company_id, $name = null)
    {
        $returnType = '\mx\wire4\client\model\SalesPointRespose';
        $request = $this->createSalesPointRequest($body, $authorization, $company_id, $name);
     ...
     */
    protected function createSalesPointRequest($body, $authorization, $company_id, $name = null)
    {
        ...
        $resourcePath = '/codi/companies/{company_id}/salespoint';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
