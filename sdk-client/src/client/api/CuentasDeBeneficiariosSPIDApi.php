...
class CuentasDeBeneficiariosSPIDApi
{
     ...
     * @param  string $account Cuenta del beneficiario, puede ser CLABE (18 dígitos), Tarjeta de débito  (TDD, 16 dígitos) o número de celular (10 dígitos). (optional)
     * @param  string $beneficiary_bank Es la clave del banco beneficiario. Se puede obtener del catalogo de &lt;a href&#x3D;\&quot;#operation/getAllInstitutionsUsingGET\&quot;&gt;instituciones.&lt;/a&gt; (optional)
     * @param  string $beneficiary_name Es el nombre del beneficiario. (optional)
     * @param  string $end_date Es la fecha de inicio del periodo a filtrar en formato dd-mm-yyyy. (optional)
     * @param  string $init_date Es la fecha de inicio del periodo a filtrar en formato dd-mm-yyyy. (optional)
     * @param  string $rfc Es el Registro Federal de Contribuyentes (RFC) del beneficiario. (optional)
