...
class TransferenciasSPEIApi
{
    ...
    protected function incomingSpeiTransactionsReportUsingGETRequest($authorization, $subscription, $begin_date = null, $end_date = null)
    {
        ...
        // query params
        if ($begin_date !== null) {
            $queryParams['beginDate'] = ObjectSerializer::toQueryValue($begin_date, null);
        }
        // query params
        if ($end_date !== null) {
    ...
    /**
     * Operation outCommingSpeiSpidOrderIdTransactionReportUsingGET
     *
     ...
     * @throws \mx\wire4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \mx\wire4\client\model\PaymentsSpeiAndSpidOrderId
     */
    public function outCommingSpeiSpidOrderIdTransactionReportUsingGET($authorization, $subscription, $order_id = null)
    {
        list($response) = $this->outCommingSpeiSpidOrderIdTransactionReportUsingGETWithHttpInfo($authorization, $subscription, $order_id);
        return $response;
    }

    /**
     * Operation outCommingSpeiSpidOrderIdTransactionReportUsingGETWithHttpInfo
     *
     * Consulta de transferencias realizadas por order_id
     *
     * @param  string $authorization Header para token (required)
     ...
     * @throws \mx\wire4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \mx\wire4\client\model\PaymentsSpeiAndSpidOrderId, HTTP status code, HTTP response headers (array of strings)
     */
    public function outCommingSpeiSpidOrderIdTransactionReportUsingGETWithHttpInfo($authorization, $subscription, $order_id = null)
    {
        $returnType = '\mx\wire4\client\model\PaymentsSpeiAndSpidOrderId';
        $request = $this->outCommingSpeiSpidOrderIdTransactionReportUsingGETRequest($authorization, $subscription, $order_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\mx\wire4\client\model\PaymentsSpeiAndSpidOrderId',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation outCommingSpeiSpidOrderIdTransactionReportUsingGETAsync
     *
     * Consulta de transferencias realizadas por order_id
     *
     * @param  string $authorization Header para token (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function outCommingSpeiSpidOrderIdTransactionReportUsingGETAsync($authorization, $subscription, $order_id = null)
    {
        return $this->outCommingSpeiSpidOrderIdTransactionReportUsingGETAsyncWithHttpInfo($authorization, $subscription, $order_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation outCommingSpeiSpidOrderIdTransactionReportUsingGETAsyncWithHttpInfo
     *
     * Consulta de transferencias realizadas por order_id
     *
     * @param  string $authorization Header para token (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function outCommingSpeiSpidOrderIdTransactionReportUsingGETAsyncWithHttpInfo($authorization, $subscription, $order_id = null)
    {
        $returnType = '\mx\wire4\client\model\PaymentsSpeiAndSpidOrderId';
        $request = $this->outCommingSpeiSpidOrderIdTransactionReportUsingGETRequest($authorization, $subscription, $order_id);
    ...
    /**
     * Create request for operation 'outCommingSpeiSpidOrderIdTransactionReportUsingGET'
     *
     * @param  string $authorization Header para token (required)
     * @param  string $subscription Es el identificador de la suscripción a esta API. (required)
     * @param  string $order_id Es el identificador de la orden a buscar. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function outCommingSpeiSpidOrderIdTransactionReportUsingGETRequest($authorization, $subscription, $order_id = null)
    {
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling outCommingSpeiSpidOrderIdTransactionReportUsingGET'
            );
        }
        // verify the required parameter 'subscription' is set
        if ($subscription === null || (is_array($subscription) && count($subscription) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $subscription when calling outCommingSpeiSpidOrderIdTransactionReportUsingGET'
            );
        }

        $resourcePath = '/subscriptions/{subscription}/transactions/outcoming';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation outCommingSpeiSpidRequestIdTransactionsReportUsingGET
     *
     * Consulta de transferencias de salida por identificador de petición
     *
     * @param  string $authorization Header para token (required)
     ...
     * @throws \mx\wire4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \mx\wire4\client\model\PaymentsSpeiAndSpidRequestId
     */
    public function outCommingSpeiSpidRequestIdTransactionsReportUsingGET($authorization, $request_id, $subscription)
    {
        list($response) = $this->outCommingSpeiSpidRequestIdTransactionsReportUsingGETWithHttpInfo($authorization, $request_id, $subscription);
        return $response;
    }

    /**
     * Operation outCommingSpeiSpidRequestIdTransactionsReportUsingGETWithHttpInfo
     *
     * Consulta de transferencias de salida por identificador de petición
     *
     * @param  string $authorization Header para token (required)
     ...
     * @throws \mx\wire4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \mx\wire4\client\model\PaymentsSpeiAndSpidRequestId, HTTP status code, HTTP response headers (array of strings)
     */
    public function outCommingSpeiSpidRequestIdTransactionsReportUsingGETWithHttpInfo($authorization, $request_id, $subscription)
    {
        $returnType = '\mx\wire4\client\model\PaymentsSpeiAndSpidRequestId';
        $request = $this->outCommingSpeiSpidRequestIdTransactionsReportUsingGETRequest($authorization, $request_id, $subscription);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\mx\wire4\client\model\PaymentsSpeiAndSpidRequestId',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation outCommingSpeiSpidRequestIdTransactionsReportUsingGETAsync
     *
     * Consulta de transferencias de salida por identificador de petición
     *
     * @param  string $authorization Header para token (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function outCommingSpeiSpidRequestIdTransactionsReportUsingGETAsync($authorization, $request_id, $subscription)
    {
        return $this->outCommingSpeiSpidRequestIdTransactionsReportUsingGETAsyncWithHttpInfo($authorization, $request_id, $subscription)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation outCommingSpeiSpidRequestIdTransactionsReportUsingGETAsyncWithHttpInfo
     *
     * Consulta de transferencias de salida por identificador de petición
     *
     * @param  string $authorization Header para token (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function outCommingSpeiSpidRequestIdTransactionsReportUsingGETAsyncWithHttpInfo($authorization, $request_id, $subscription)
    {
        $returnType = '\mx\wire4\client\model\PaymentsSpeiAndSpidRequestId';
        $request = $this->outCommingSpeiSpidRequestIdTransactionsReportUsingGETRequest($authorization, $request_id, $subscription);
    ...
    /**
     * Create request for operation 'outCommingSpeiSpidRequestIdTransactionsReportUsingGET'
     *
     * @param  string $authorization Header para token (required)
     * @param  string $request_id Identificador de la petición a buscar. (required)
     * @param  string $subscription Es el identificador de la suscripción a esta API. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function outCommingSpeiSpidRequestIdTransactionsReportUsingGETRequest($authorization, $request_id, $subscription)
    {
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling outCommingSpeiSpidRequestIdTransactionsReportUsingGET'
            );
        }
        // verify the required parameter 'request_id' is set
        if ($request_id === null || (is_array($request_id) && count($request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request_id when calling outCommingSpeiSpidRequestIdTransactionsReportUsingGET'
            );
        }
        // verify the required parameter 'subscription' is set
        if ($subscription === null || (is_array($subscription) && count($subscription) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $subscription when calling outCommingSpeiSpidRequestIdTransactionsReportUsingGET'
            );
        }

        $resourcePath = '/subscriptions/{subscription}/transactions/outcoming/{requestId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation registerSpeiSpidOutgoingTransactionsUsingPOST
     *
     * Registro de transferencias SPEI y SPID
     *
     * @param  \mx\wire4\client\model\TransactionsRegister $body Información de las transferencias SPEI y SPID de salida (required)
     * @param  string $authorization Header para token (required)
     * @param  string $subscription Es el identificador de la suscripción a esta API. (required)
     *
     * @throws \mx\wire4\ApiException on non-2xx response
     ...
     * @return \mx\wire4\client\model\TokenRequiredResponse
     */
    public function registerSpeiSpidOutgoingTransactionsUsingPOST($body, $authorization, $subscription)
    {
        list($response) = $this->registerSpeiSpidOutgoingTransactionsUsingPOSTWithHttpInfo($body, $authorization, $subscription);
        return $response;
    }

    /**
     * Operation registerSpeiSpidOutgoingTransactionsUsingPOSTWithHttpInfo
     *
     * Registro de transferencias SPEI y SPID
     *
     * @param  \mx\wire4\client\model\TransactionsRegister $body Información de las transferencias SPEI y SPID de salida (required)
     ...
     * @return array of \mx\wire4\client\model\TokenRequiredResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function registerSpeiSpidOutgoingTransactionsUsingPOSTWithHttpInfo($body, $authorization, $subscription)
    {
        $returnType = '\mx\wire4\client\model\TokenRequiredResponse';
        $request = $this->registerSpeiSpidOutgoingTransactionsUsingPOSTRequest($body, $authorization, $subscription);
    ...
    /**
     * Operation registerSpeiSpidOutgoingTransactionsUsingPOSTAsync
     *
     * Registro de transferencias SPEI y SPID
     *
     * @param  \mx\wire4\client\model\TransactionsRegister $body Información de las transferencias SPEI y SPID de salida (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function registerSpeiSpidOutgoingTransactionsUsingPOSTAsync($body, $authorization, $subscription)
    {
        return $this->registerSpeiSpidOutgoingTransactionsUsingPOSTAsyncWithHttpInfo($body, $authorization, $subscription)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation registerSpeiSpidOutgoingTransactionsUsingPOSTAsyncWithHttpInfo
     *
     * Registro de transferencias SPEI y SPID
     *
     * @param  \mx\wire4\client\model\TransactionsRegister $body Información de las transferencias SPEI y SPID de salida (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function registerSpeiSpidOutgoingTransactionsUsingPOSTAsyncWithHttpInfo($body, $authorization, $subscription)
    {
        $returnType = '\mx\wire4\client\model\TokenRequiredResponse';
        $request = $this->registerSpeiSpidOutgoingTransactionsUsingPOSTRequest($body, $authorization, $subscription);
    ...
    /**
     * Create request for operation 'registerSpeiSpidOutgoingTransactionsUsingPOST'
     *
     * @param  \mx\wire4\client\model\TransactionsRegister $body Información de las transferencias SPEI y SPID de salida (required)
     * @param  string $authorization Header para token (required)
     * @param  string $subscription Es el identificador de la suscripción a esta API. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function registerSpeiSpidOutgoingTransactionsUsingPOSTRequest($body, $authorization, $subscription)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling registerSpeiSpidOutgoingTransactionsUsingPOST'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling registerSpeiSpidOutgoingTransactionsUsingPOST'
            );
        }
        // verify the required parameter 'subscription' is set
        if ($subscription === null || (is_array($subscription) && count($subscription) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $subscription when calling registerSpeiSpidOutgoingTransactionsUsingPOST'
            );
        }
