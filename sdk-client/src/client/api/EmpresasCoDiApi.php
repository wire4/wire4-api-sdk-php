...
/**
 * EmpresasCoDiApi Class Doc Comment
 *
 * @category Class
 * @package  mx\wire4
 * @author   Swagger Codegen team
...
class EmpresasCoDiApi
{
     ...
     * @return \mx\wire4\client\model\CompanyRegistered[]
     */
    public function obtainCompanies($authorization)
    {
        list($response) = $this->obtainCompaniesWithHttpInfo($authorization);
        return $response;
    }

    /**
     * Operation obtainCompaniesWithHttpInfo
     *
     * Consulta de empresas CODI®
     *
     * @param  string $authorization Header para token (required)
     ...
     * @throws \mx\wire4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \mx\wire4\client\model\CompanyRegistered[], HTTP status code, HTTP response headers (array of strings)
     */
    public function obtainCompaniesWithHttpInfo($authorization)
    {
        $returnType = '\mx\wire4\client\model\CompanyRegistered[]';
        $request = $this->obtainCompaniesRequest($authorization);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\mx\wire4\client\model\CompanyRegistered[]',
    ...
    /**
     * Operation obtainCompaniesAsync
     *
     * Consulta de empresas CODI®
     *
     * @param  string $authorization Header para token (required)
     ...
     */
    public function obtainCompaniesAsync($authorization)
    {
        return $this->obtainCompaniesAsyncWithHttpInfo($authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation obtainCompaniesAsyncWithHttpInfo
     *
     * Consulta de empresas CODI®
     *
     * @param  string $authorization Header para token (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function obtainCompaniesAsyncWithHttpInfo($authorization)
    {
        $returnType = '\mx\wire4\client\model\CompanyRegistered[]';
        $request = $this->obtainCompaniesRequest($authorization);
    ...
    /**
     * Create request for operation 'obtainCompanies'
     *
     * @param  string $authorization Header para token (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function obtainCompaniesRequest($authorization)
    {
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling obtainCompanies'
            );
        }

        $resourcePath = '/codi/companies';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation registerCompanyUsingPOST
     *
     * Registro de empresas CODI®
     *
     * @param  \mx\wire4\client\model\CompanyRequested $body Información de la cuenta del beneficiario (required)
     * @param  string $authorization Header para token (required)
     *
     * @throws \mx\wire4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \mx\wire4\client\model\CompanyRegistered
     */
    public function registerCompanyUsingPOST($body, $authorization)
    {
        list($response) = $this->registerCompanyUsingPOSTWithHttpInfo($body, $authorization);
        return $response;
    }

    /**
     * Operation registerCompanyUsingPOSTWithHttpInfo
     *
     * Registro de empresas CODI®
     *
     * @param  \mx\wire4\client\model\CompanyRequested $body Información de la cuenta del beneficiario (required)
     ...
     * @return array of \mx\wire4\client\model\CompanyRegistered, HTTP status code, HTTP response headers (array of strings)
     */
    public function registerCompanyUsingPOSTWithHttpInfo($body, $authorization)
    {
        $returnType = '\mx\wire4\client\model\CompanyRegistered';
        $request = $this->registerCompanyUsingPOSTRequest($body, $authorization);
    ...
    /**
     * Operation registerCompanyUsingPOSTAsync
     *
     * Registro de empresas CODI®
     *
     * @param  \mx\wire4\client\model\CompanyRequested $body Información de la cuenta del beneficiario (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function registerCompanyUsingPOSTAsync($body, $authorization)
    {
        return $this->registerCompanyUsingPOSTAsyncWithHttpInfo($body, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation registerCompanyUsingPOSTAsyncWithHttpInfo
     *
     * Registro de empresas CODI®
     *
     * @param  \mx\wire4\client\model\CompanyRequested $body Información de la cuenta del beneficiario (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function registerCompanyUsingPOSTAsyncWithHttpInfo($body, $authorization)
    {
        $returnType = '\mx\wire4\client\model\CompanyRegistered';
        $request = $this->registerCompanyUsingPOSTRequest($body, $authorization);
    ...
    /**
     * Create request for operation 'registerCompanyUsingPOST'
     *
     * @param  \mx\wire4\client\model\CompanyRequested $body Información de la cuenta del beneficiario (required)
     * @param  string $authorization Header para token (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function registerCompanyUsingPOSTRequest($body, $authorization)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling registerCompanyUsingPOST'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling registerCompanyUsingPOST'
            );
        }
