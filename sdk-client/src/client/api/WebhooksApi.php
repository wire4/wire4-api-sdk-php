...
class WebhooksApi
{
     ...
     * @param  string $webhook_id Es el identificador del webhook. Ejemplo: wh_54a932866f784b439bc625c0f4e04e12 (required)
     *
     * @throws \mx\wire4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \mx\wire4\client\model\WebhookResponse
     */
    public function getWebhook($authorization, $webhook_id)
    {
        list($response) = $this->getWebhookWithHttpInfo($authorization, $webhook_id);
        return $response;
    }
     ...
     */
    public function getWebhookWithHttpInfo($authorization, $webhook_id)
    {
        $returnType = '\mx\wire4\client\model\WebhookResponse';
        $request = $this->getWebhookRequest($authorization, $webhook_id);
     ...
     */
    public function getWebhookAsync($authorization, $webhook_id)
    {
        return $this->getWebhookAsyncWithHttpInfo($authorization, $webhook_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebhookAsyncWithHttpInfo($authorization, $webhook_id)
    {
        $returnType = '\mx\wire4\client\model\WebhookResponse';
        $request = $this->getWebhookRequest($authorization, $webhook_id);
     ...
     */
    protected function getWebhookRequest($authorization, $webhook_id)
    {
