...
class CuentasDeBeneficiariosSPEIApi
{
     ...
     * @return \mx\wire4\client\model\BeneficiariesResponse
     */
    public function getBeneficiariesForAccountUsingGET($authorization, $subscription, $account = null, $beneficiary_bank = null, $beneficiary_name = null, $end_date = null, $init_date = null, $page = '0', $rfc = null, $size = '20', $status = null)
    {
        list($response) = $this->getBeneficiariesForAccountUsingGETWithHttpInfo($authorization, $subscription, $account, $beneficiary_bank, $beneficiary_name, $end_date, $init_date, $page, $rfc, $size, $status);
        return $response;
    }
     ...
     * @return array of \mx\wire4\client\model\BeneficiariesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBeneficiariesForAccountUsingGETWithHttpInfo($authorization, $subscription, $account = null, $beneficiary_bank = null, $beneficiary_name = null, $end_date = null, $init_date = null, $page = '0', $rfc = null, $size = '20', $status = null)
    {
        $returnType = '\mx\wire4\client\model\BeneficiariesResponse';
        $request = $this->getBeneficiariesForAccountUsingGETRequest($authorization, $subscription, $account, $beneficiary_bank, $beneficiary_name, $end_date, $init_date, $page, $rfc, $size, $status);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBeneficiariesForAccountUsingGETAsync($authorization, $subscription, $account = null, $beneficiary_bank = null, $beneficiary_name = null, $end_date = null, $init_date = null, $page = '0', $rfc = null, $size = '20', $status = null)
    {
        return $this->getBeneficiariesForAccountUsingGETAsyncWithHttpInfo($authorization, $subscription, $account, $beneficiary_bank, $beneficiary_name, $end_date, $init_date, $page, $rfc, $size, $status)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBeneficiariesForAccountUsingGETAsyncWithHttpInfo($authorization, $subscription, $account = null, $beneficiary_bank = null, $beneficiary_name = null, $end_date = null, $init_date = null, $page = '0', $rfc = null, $size = '20', $status = null)
    {
        $returnType = '\mx\wire4\client\model\BeneficiariesResponse';
        $request = $this->getBeneficiariesForAccountUsingGETRequest($authorization, $subscription, $account, $beneficiary_bank, $beneficiary_name, $end_date, $init_date, $page, $rfc, $size, $status);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getBeneficiariesForAccountUsingGETRequest($authorization, $subscription, $account = null, $beneficiary_bank = null, $beneficiary_name = null, $end_date = null, $init_date = null, $page = '0', $rfc = null, $size = '20', $status = null)
    {
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
