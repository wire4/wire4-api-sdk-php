...
class PeticionesDePagoPorCoDiApi
{
    ...
    protected function consultCodiRequestByOrderIdRequest($authorization, $order_id, $sales_point_id)
    {
        ...
        $resourcePath = '/codi/sales-point/{sales_point_id}/charges/{order_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($sales_point_id !== null) {
            $resourcePath = str_replace(
                '{' . 'sales_point_id' . '}',
                ObjectSerializer::toPathValue($sales_point_id),
                $resourcePath
            );
        }
    ...
    protected function generateCodiCodeQRRequest($body, $authorization, $sales_point_id)
    {
        ...
        $resourcePath = '/codi/sales-point/{salesPointId}/charges';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
