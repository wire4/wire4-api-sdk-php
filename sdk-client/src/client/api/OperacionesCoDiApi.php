...
class OperacionesCoDiApi
{
     ...
     * @param  string $page Es el número de pago. (optional)
     * @param  string $sales_point_id Es el identificador del punto de venta. (optional)
     * @param  string $size Es el tamaño de página. (optional)
     *
     * @throws \mx\wire4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \mx\wire4\client\model\PagerResponseDto
     */
    public function consultCodiOperations($authorization, $body = null, $company_id = null, $page = null, $sales_point_id = null, $size = null)
    {
     ...
     */
    public function consultCodiOperationsWithHttpInfo($authorization, $body = null, $company_id = null, $page = null, $sales_point_id = null, $size = null)
    {
     ...
     */
    public function consultCodiOperationsAsync($authorization, $body = null, $company_id = null, $page = null, $sales_point_id = null, $size = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function consultCodiOperationsAsyncWithHttpInfo($authorization, $body = null, $company_id = null, $page = null, $sales_point_id = null, $size = null)
    {
        $returnType = '\mx\wire4\client\model\PagerResponseDto';
        $request = $this->consultCodiOperationsRequest($authorization, $body, $company_id, $page, $sales_point_id, $size);
     ...
     */
    protected function consultCodiOperationsRequest($authorization, $body = null, $company_id = null, $page = null, $sales_point_id = null, $size = null)
    {
        ...
        if ($sales_point_id !== null) {
            $queryParams['sales_point_id'] = ObjectSerializer::toQueryValue($sales_point_id);
        }
        // query params
        if ($size !== null) {
