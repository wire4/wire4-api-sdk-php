...
class OperacionesCoDiApi
{
     ...
     * @param  string $company_id Identificador de empresa CoDi (optional)
     * @param  string $page Número de pago (optional)
     * @param  string $sales_point_id Identificador del punto de venta (optional)
     * @param  string $size Tamaño de pagina (optional)
     *
